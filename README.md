# [dividend-investment](https://dividend-investment-chi.vercel.app/holdings)

국내/해외 주식·ETF의 배당 정보 조회, 포트폴리오 관리, 배당 캘린더, 세후 DCA 시나리오 시뮬레이션을 제공하는 배당 투자 플래닝 웹서비스입니다.
`OMC`를 활용하여 바이브 코딩으로 제작했습니다.
